...
const Navbar = () => {
    ...
    const search = (e) => {
        e.preventDefault()
        userService.searchUsers(query).then((result) => {
    ...
    return <>
        <nav className="my-navbar navbar sticky-top navbar-light justify-content-around">
            <a className="navbar-brand ml-2" href="http://localhost:3000/home">
            <img alt="Instagram" src={logo} height="30px"/>
            </a>
            <form  className="form-inline my-search" onSubmit={(e)=>search(e)}>
            ...
            <div className="options d-flex justify-content-center">
                <a href="http://localhost:3000/home" tabindex="0">
                    <svg className="_8-yf5 " color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
